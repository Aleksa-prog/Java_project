...
public class ClientView extends JFrame {
    ...
    public ClientView(String id, Socket s) throws IOException { // constructor call, it will initialize required variables
        ...
        this.id = id;
        try {
            //file = "C://Users//User//Desktop//Функ.Прог//proj_of_mine_2//Steffany.txt";
            file = "C://Users//User//Desktop//Функ.Прог//proj_of_mine_2//" + id + ".txt";
            ...
            if((new File(file)).exists()){
                ...
                //File f = new File("C://Users//User//Desktop//Функ.Прог//proj_of_mine_2//Steffany.txt");
                File f = new File("C://Users//User//Desktop//Функ.Прог//proj_of_mine_2//" + id + ".txt");
                f.createNewFile();
            }
        }
                    ...
                    try {
                        ...
                        if (cast.equalsIgnoreCase("multicast")) {
                            if (flag == 1) { // for multicast check if no user was selected then prompt a message dialog
                                ...
                                String read21 = clientMessageBoard.getText();
                                ...
                                writer21.print(read21);
                                //writer.println(("<" + id + " to " + clientIds + " || " + date + ">" + ": " + "\n" + textAreaMessage.toString() + "\n" + "\n" + "<" + clientIds + ">" + textAreaMessage.toString() + "\n"));
                                writer21.flush();
                                writer21.close();//show the sent message to the sender's message board
                            }
                            ...
                            //writer1.println(("From " + id + " to All" + clientActiveUsersList.getSelectedValuesList() + ":" + textAreaMessage.toString()));
                            writer1.flush();
                            writer1.close();
                        }
        ...
        clientKillProcessBtn.addActionListener(new ActionListener() { // kill process event
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    // board
                    String read22 = clientMessageBoard.getText();
